...
public class Colortester{
    public static void main(String[] args){
        ...
        StageTwo.placeItem(volcano,6,9);
        StageTwo.placeItem(volcano,9,14);
        StageTwo.placeItem(water,0,0);
        StageTwo.placeItem(water,1,0);
        StageTwo.placeItem(water,1,1);
        StageTwo.placeItem(water,1,2);
        StageTwo.placeItem(tree,3, 6);
        StageTwo.placeItem(tree,3, 7);
        StageTwo.placeItem(tree,3, 8);
        StageTwo.placeItem(tree,2, 5);
        StageTwo.placeItem(tree,9, 6);
        StageTwo.placeItem(tree,4, 7);
        StageTwo.placeItem(tree,6, 8);
        StageTwo.placeItem(tree,7, 5);
...
//        StageOne.placeItem(loot,8, 12);
//        StageOne.placeItem(loot,6, 0);
